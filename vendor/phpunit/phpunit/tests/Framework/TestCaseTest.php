...
class TestCaseTest extends TestCase
{
    ...
    public function testExceptionWithWrongMessage()
    {
        ...
        $this->assertCount(1, $result);
        $this->assertEquals(
            "Failed asserting that TemperatureException message 'A runtime error occurred' contains 'A logic error occurred'.",
    ...
    public function testExceptionWithWrongRegexpMessage()
    {
        ...
        $this->assertCount(1, $result);
        $this->assertEquals(
            "Failed asserting that TemperatureException message 'A runtime error occurred' matches '/logic .*? occurred/'.",
            $test->getStatusMessage()
        );
    }
    ...
    public function testExceptionWithInvalidRegexpMessage()
    {
        ...
        $this->assertEquals(
            "Invalid expected TemperatureException message regex given: '#runtime .*? occurred/'",
            $test->getStatusMessage()
        );
    }
