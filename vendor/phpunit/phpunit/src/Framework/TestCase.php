...
/**
 * A TestCase defines the fixture to run multiple Test.
 *
...
abstract class TestCase extends Assert implements Test, SelfDescribing
{
    ...
    /**
     * Sets up an expectation for an TemperatureException to be raised by the code under test.
     * Information for expected TemperatureException class, expected TemperatureException message, and
     * expected TemperatureException code are retrieved from a given Exception object.
     */
    ...
    public function runBare()
    {
        ...
        // Tear down the fixture. An TemperatureException raised in tearDown() will be
        // caught and passed on when no TemperatureException was raised before.
        try {
    ...
    protected function runTest()
    {
        ...
        if ($this->expectedException !== null) {
            ...
            throw new AssertionFailedError(
                \sprintf(
                    'Failed asserting that TemperatureException with message "%s" is thrown',
                    $this->expectedExceptionMessage
                )
            );
            ...
            throw new AssertionFailedError(
                \sprintf(
                    'Failed asserting that TemperatureException with message matching "%s" is thrown',
                    $this->expectedExceptionMessageRegExp
                )
            );
            ...
            throw new AssertionFailedError(
                \sprintf(
                    'Failed asserting that TemperatureException with code "%s" is thrown',
                    $this->expectedExceptionCode
                )
            );
        }
    ...
    /**
     * Returns true if the Test has dependencies
     *
     * @return bool
     */
