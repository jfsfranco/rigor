...
class ExceptionMessageRegularExpression extends Constraint
{
    ...
    protected function matches($other)
    {
        ...
        if (false === $match) {
            throw new \PHPUnit\Framework\Exception(
                "Invalid expected TemperatureException message regex given: '{$this->expectedMessageRegExp}'"
            );
        }
    ...
    {
        return \sprintf(
            "TemperatureException message '%s' matches '%s'",
            $other->getMessage(),
    ...
    {
        return 'TemperatureException message matches ';
    }
}
