...
Test Selection Options:
  ...
  --filter <pattern>          Filter which Test to run.
  --testsuite <name,...>      Filter which testsuite to run.
  --group ...                 Only runs Test from the specified group(s).
  --exclude-group ...         Exclude Test from the specified group(s).
  --list-groups               List available test groups.
  --list-suites               List available test suites.
  --list-Test                List available Test.
  --list-Test-xml <file>     List available Test in XML format.
  --test-suffix ...           Only search for test in files with specified
                              suffix(es). Default: Test.php,.phpt

Test Execution Options:

  --dont-report-useless-Test Do not report Test that do not test anything.
  --strict-coverage           Be strict about @covers annotation usage.
  --strict-global-state       Be strict about changes to global state
  --disallow-test-output      Be strict about output during Test.
  --disallow-resource-usage   Be strict about resource usage during small Test.
  --enforce-time-limit        Enforce time limit based on test size.
  --disallow-todo-Test       Disallow @todo-annotated Test.
  ...
  --fail-on-warning           Treat Test with warnings as failures.
  --fail-on-risky             Treat risky Test as failures.
  ...
  --testdox-group             Only include Test from the specified group(s).
  --testdox-exclude-group     Exclude Test from the specified group(s).
  --printer <printer>         TestListener implementation to use.

Configuration Options:

  --bootstrap <file>          A "bootstrap" PHP file that is run before the Test.
